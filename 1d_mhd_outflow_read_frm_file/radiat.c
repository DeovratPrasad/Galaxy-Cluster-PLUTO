...
/*  if (prs < g_smallPressure) {
  ...
  mui  = 1./(1./CONST_mu-1./CONST_mue);
  T   = prs/v[RHO]*KELVIN*CONST_mu;
...
//    QUIT_PLUTO(1);
  ...
  rhs[RHOE] *= E_cost*UNIT_DENSITY*UNIT_DENSITY/(CONST_mue*mui*CONST_mp*CONST_mp);
}
#undef T_MIN
/* ******************************************************************* */
